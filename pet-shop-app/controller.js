...
return{
	getAllPets: function(req, res){
		console.log("getting all pets from database: ");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // queryAllPets - requires no arguments , ex: args: [''],
		    const request = {
		        chaincodeId: 'pet-shop',
		        txId: tx_id,
		        fcn: 'queryAllPets',
		        args: ['']
		    };
	...
	adoptPet: function(req, res){
		console.log("changing owner of pet: ");

		var petId = req.params.id;
		var owner = "newOwnerAddress";
